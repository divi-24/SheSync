  ...
  return (
    <div className="quiz bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
      {showScore ? (
        ...
        <>
          <div className="question-section mb-6 text-gray-900 dark:text-gray-200">
            <div className="question-count font-medium mb-2">
              Question {currentQuestion + 1} of {questions.length}
            </div>
            <h3 className="question-text text-xl font-semibold mb-4 text-gray-900 dark:text-gray-200">
              ...
              <button
                ...
                className={`px-4 py-3 text-sm font-medium text-left rounded-md transition-colors duration-300 flex justify-between items-center ${
                  answered
                    ...
                    : 'bg-pink-100 text-pink-800 hover:bg-pink-200 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600'
                }`}
                disabled={answered}
              >
          ...
          {explanation && (
            <div className={`mb-6 p-4 rounded-md ${
              answered && selectedAnswer !== null && questions[currentQuestion].answerOptions[selectedAnswer].isCorrect 
