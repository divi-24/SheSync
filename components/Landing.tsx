...
const SuccessStoryCard = ({ name, story, improvement, className }: { 
  name: string; 
  story: string; 
  improvement: string; 
  className?: string;
  ...
  return (
    <div className={`bg-pink-50 dark:bg-pink-50 p-6 rounded-lg border border-pink-700 dark:border-pink-700 borderw-4 ${className}`}>
...
const ExpertInsightCard = ({ expert, insight }: { expert: string; insight: string }) => {
  return (
...
const CommunityHighlightCard = ({ title, description }: { title: string; description: string }) => {
  return (
