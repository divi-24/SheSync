...
export function Blogs() {
    ...
    const { theme, toggleTheme } = useTheme(); // 🔥 ADDED: Theme context hook
    ...
    // 🔥 FIXED: handleShare function with proper syntax
    ...
    const searchFilteredPosts = filteredPosts.filter(post =>
        post.title.props.children.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    return (
        <div className="flex h-screen">
            <SideBar
                ...
                activeLink={2}
                toggleDarkMode={toggleTheme} // 🔥 FIXED: Use global theme toggle
            />
            ...
            >
                <div className="max-w-6xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0 w-full items-stretch">
                        ...
                        <div className="w-full sm:w-[70%] flex">
                            <div className="relative w-full pt-4 flex items-center">
                                <input
                                    ...
                                    className="w-full h-11 px-4 pr-10 rounded-full border focus:outline-none focus:ring-2 focus:ring-pink-300 transition-all duration-300 focus:shadow-lg"
                                    style={{
                                ...
                                />
                                <Search
                                    className="absolute right-3 h-5 w-5 pointer-events-none"
                                    style={{
                        ...
                        {/* Category Dropdown - 🔥 FORCED FIX: Explicit inline styling */}
                        <div className="w-30 sm:w-[30%] flex items-center">
                            <div className="relative w-full mt-1 pt-0.1 h-11">
                                <select
                                    value={selectedCategory}
                                    onChange={(e) => setSelectedCategory(e.target.value)}
                                    className="w-full h-full px-4 rounded-full border focus:outline-none focus:ring-2 focus:ring-pink-300 transition-all duration-300 focus:shadow-lg appearance-none"
                                    style={{
                                        backgroundColor: theme === 'dark' ? '#374151' : '#ffffff',
                                        color: theme === 'dark' ? '#ffffff' : '#111827',
                                        borderColor: theme === 'dark' ? '#4B5563' : '#D1D5DB',
                    ...
                    {/* Women's Health Topics Section - 🔥 FIXED: Light mode styling */}
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
                        ...
                        {/* Progress Bar - 🔥 FIXED: Proper light/dark mode styling */}
                        <div
                            className="w-full rounded-full h-2.5 mb-6 overflow-hidden"
                            style={{
                        ...
                        {/* Accordion - 🔥 COMPLETELY FIXED: Using inline styles for light mode */}
                            ...
                            {womenHealthTopics.map(({ id, question, answer }, index) => (
                                ...
                                >
                                    <button
                                        ...
                                        onMouseEnter={(e) => {
                                            e.target.style.backgroundColor = theme === 'dark' ? '#4B5563' : '#F3F4F6';
                                        }}
                                        onMouseLeave={(e) => {
