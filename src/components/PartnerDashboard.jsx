    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        <input
          ...
          className="text-gray-800 w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-pink-300 dark:bg-gray-700 dark:text-white"
        />
